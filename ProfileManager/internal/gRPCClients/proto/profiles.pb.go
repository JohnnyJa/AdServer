...
type Creative struct {
	...
	CreativeTargeting map[string]string      `protobuf:"bytes,6,rep,name=creative_targeting,json=creativeTargeting,proto3" json:"creative_targeting,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type Profile struct {
	...
	Creatives     map[string]*Creative   `protobuf:"bytes,3,rep,name=creatives,proto3" json:"creatives,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // map[uuid]string -> Creative
	PackageIds    []string               `protobuf:"bytes,4,rep,name=package_ids,json=packageIds,proto3" json:"package_ids,omitempty"`                                                       // UUIDs як рядки
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_profiles_proto_rawDesc = "" +
	...
	"\x12GetProfilesRequest\"\xaa\x02\n" +
	"\bCreative\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\tmedia_url\x18\x02 \x01(\tR\bmediaUrl\x12\x14\n" +
	"\x05width\x18\x03 \x01(\x05R\x05width\x12\x16\n" +
	"\x06height\x18\x04 \x01(\x05R\x06height\x12#\n" +
	"\rcreative_type\x18\x05 \x01(\tR\fcreativeType\x12X\n" +
	"\x12creative_targeting\x18\x06 \x03(\v2).profiles.Creative.CreativeTargetingEntryR\x11creativeTargeting\x1aD\n" +
	...
	"\tcreatives\x18\x03 \x03(\v2 .profiles.Profile.CreativesEntryR\tcreatives\x12\x1f\n" +
	"\vpackage_ids\x18\x04 \x03(\tR\n" +
	"packageIds\x1aP\n" +
	"\x0eCreativesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.profiles.CreativeR\x05value:\x028\x01\"D\n" +
...
var file_profiles_proto_goTypes = []any{
	...
	nil,                         // 4: profiles.Creative.CreativeTargetingEntry
	nil,                         // 5: profiles.Profile.CreativesEntry
}
var file_profiles_proto_depIdxs = []int32{
	4, // 0: profiles.Creative.creative_targeting:type_name -> profiles.Creative.CreativeTargetingEntry
	5, // 1: profiles.Profile.creatives:type_name -> profiles.Profile.CreativesEntry
